...
public sealed partial class ExpressionTreeCloner
{
        ...
        ICollection<ParameterExpression> variables)
    {
        ...
        var propertyInfos = clonedType.GetProperties(
            BindingFlags.Public |
    ...
    private static UnaryExpression GeneratePropertyBasedPrimitiveArrayTransferExpressions(
        Type clonedType,
        Expression original)
    {
        var arrayCloneMethodInfo = typeof(Array).GetMethod(nameof(Array.Clone));
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        var getOrCreateClonerMethodInfo = typeof(ExpressionTreeCloner).GetMethod(
                            nameof(GetOrCreateDeepPropertyBasedCloner),
    ...
    /// </param>
    /// <param name="variables">Receives variables used by the transfer expressions.</param>
    /// <param name="propertyInfo">Reflection information about the property being cloned.</param>
