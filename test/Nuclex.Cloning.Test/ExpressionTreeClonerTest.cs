...
[TestFixture]
internal sealed class ExpressionTreeClonerTest : CloneFactoryTest
{
    /// <summary>Clone factory being tested.</summary>
    private readonly ICloneFactory cloneFactory;

    /// <summary>
    /// Initializes a new instance of the <see cref="ExpressionTreeClonerTest"/> class.
    /// </summary>
    ...
    [SuppressMessage(
        ...
        Justification = "Intentionally testing jagged arrays")]
    public void DeepClonesOfArraysCanBeMade()
    {
        ...
        clone[0, 0].Should().NotBeSameAs(original[0, 0]);
        clone[0, 0].TestField.Should().Be(original[0, 0].TestField);
        clone[0, 0].TestProperty.Should().Be(original[0, 0].TestProperty);
    }
